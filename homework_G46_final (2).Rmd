...
author: "Group 46 - Antonio Pagnotta, Beatrice Mazzocchi, Domenico Mangieri"
output:
...
required_packages <- c("dplyr", "zoo", "fda", "ggplot2", "reshape2", "gridExtra", "prettydoc","plotly","MASS")
...
```{r conformal-ellipsoids, warning=FALSE, message=FALSE}
